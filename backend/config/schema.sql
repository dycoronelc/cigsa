...
CREATE TABLE IF NOT EXISTS work_orders (
  ...
  superintendent_signature_path VARCHAR(500) NULL COMMENT 'Imagen firma superintendente (adjunta por admin)',
  superintendent_signature_signed_by VARCHAR(200) NULL,
  superintendent_signature_signed_at DATETIME NULL,
